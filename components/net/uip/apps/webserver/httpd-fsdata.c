...
const struct httpd_fsdata_file file_stats_shtml[] = {{NULL, data_stats_shtml, data_stats_shtml + 13, sizeof(data_stats_shtml) - 13}};

const struct httpd_fsdata_file file_tcp_shtml[] = {{file_stats_shtml, data_tcp_shtml, data_tcp_shtml + 11, sizeof(data_tcp_shtml) - 11}};

const struct httpd_fsdata_file file_processes_shtml[] = {{file_tcp_shtml, data_processes_shtml, data_processes_shtml + 17, sizeof(data_processes_shtml) - 17}};

const struct httpd_fsdata_file file_fade_png[] = {{file_processes_shtml, data_fade_png, data_fade_png + 10, sizeof(data_fade_png) - 10}};
...
const struct httpd_fsdata_file file_header_html[] = {{file_files_shtml, data_header_html, data_header_html + 13, sizeof(data_header_html) - 13}};
...
const struct httpd_fsdata_file file_style_css[] = {{file_footer_html, data_style_css, data_style_css + 11, sizeof(data_style_css) - 11}};

const struct httpd_fsdata_file file_index_html[] = {{file_style_css, data_index_html, data_index_html + 12, sizeof(data_index_html) - 12}};

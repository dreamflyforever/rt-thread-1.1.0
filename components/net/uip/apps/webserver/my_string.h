...
char *strncpy(char *dest, const char *src, rt_size_t siz)
{
	return (char *)rt_strncpy(dest, src, siz);
}

unsigned long  strlcpy(char *dst, const char *src, rt_size_t siz)
{
	register char *d = dst;
 ...
 */
int strncmp(const char *cs,const char *ct, rt_size_t count)
{
...
char *strncat(char *dest, const char *src, rt_size_t count)
{
	char *tmp = dest;
...
#endif
rt_size_t strspn(const char *s, const char *accept)
{
	rt_size_t l=0;
...
rt_size_t strcspn(const char *s, const char *reject)
{
	rt_size_t l=0;
